...
import styles from '../CategoryContent/CategoryContent.module.scss';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faHtml5, faCss3Alt, faReact, faPython, faJs } from '@fortawesome/free-brands-svg-icons';
    ...
    <div className={cx('container_category-contents')} style={{ zIndex: 2 }}>
      <div id="banthan" className={cx('container_category-content', 'flexing')} style={{ boxShadow: '0 6px 10px rgba(0,0,0, 0.2)' }}>
        <div className={cx('category-content-intromyself')}>
          ...
          <p>
            Mình tên là Trần trung Kiên, năm nay mình 21 tuổi, mình sinh ra và lớn lên tại quê hương Nam Định, hiện tại mình đang sinh sống và học tập
            tại Hà Nội và mình đang theo học tại Học Viện Công nghệ Bưu Chính Viễn Thông, chuyên ngành của mình là Phát Triển ứng Dụng thuộc ngành
            Công Nghê Đa Phương Tiện.
          </p>
        </div>
        <div className={cx('category-content-mylike')}>
          ...
          <div className={cx('mygamelike')}>
            ...
            <div className={cx('mylikegwshow')}>
              <img src={images.hacker} alt="" className={cx('imggwshow')} />
            ...
            <div className={cx('mylikegwshow')}>
              <img src={images.hagiang} alt="" className={cx('imggwshow')} />
              <ul className={cx('mylikegwshowul')}>
                <h3>Hà Giang</h3>
                <p>
                  Vi vu với những đường đèo hiểm trở số 1, chúng ta sẽ tham quan sông Nho Quế, cột cờ Lũng Cú, đèo mã Pí Lèng, cao nguyên đá Đồng
                  Văn,...Còn chờ gì mà không xách balo lên và đi nào, chắc chắn sẽ mang lại cho bạn cảm giác tuyệt vời!
                </p>
              </ul>
            </div>
            <div className={cx('mygamelike-content')}>
            ...
            <div className={cx('mylikegwshow')}>
              <img src={images.thuyen} alt="" className={cx('imggwshow')} />
              <ul className={cx('mylikegwshowul')}>
            ...
            <div className={cx('mylikegwshow')}>
              <img src={images.hotam} alt="" className={cx('imggwshow')} />
              <ul className={cx('mylikegwshowul')}>
                <h3>Hộ Tâm</h3>
                <p>
                  Bộ phim kể về chuyện tình yêu đầy trắc trở của cặp tình nhân huyền yêu, sau khi trải qua muôn và vạn thử thách thì cuối cùng họ cũng
                  đã được ở bên cạnh nhau.
                </p>
              </ul>
            </div>
          </div>
      ...
      <div id="hocvan" className={cx('container_category-content', 'flexing')} style={{ boxShadow: '0 6px 10px rgba(0,0,0, 0.2)' }}>
        ...
        <div className={cx('educations')}>
          <div className={cx('educationschool')}>
            ...
            <p>
              Mình trúng tuyển vào Học Viện với số điểm 26.05 và hiện tại mình đang là sinh viên năm thứ tư của Học Viện. Mình khá tự hào khi là sinh
              viên của Học Viện còn gpa của mình thì ngược lại, mình rất thất vọng về nó.
            </p>
          </div>
          ...
          <div className={cx('educationschool')}>
            ...
            <p>
              Đầu năm 2022 mình đã biết đến F8 là một trang web rất chi là phù hợp cho những bạn có đam mê với ngành lập trình web. Ở đây có rất nhiều
              khóa học cực kì hay và tâm huyết do anh Sơn Đặng tạo ra và đa số là khóa học free. Nhưng nếu bạn bỏ tiền ra mua khóa học mất tiền thì
              tin mình đi bạn sẽ không bao giờ thất vọng đâu, kiến thức bạn thu được sẽ là rất nhiều so với số tiền bạn bỏ ra.
            </p>
          </div>
          ...
          <div className={cx('educationschoolnobefore')}>
            ...
            <p>
              Funix là một trung tâm dạy học với đa nội dung từ lập trình, tiếng anh, ..... Chúng ta sẽ cần mất học phí khi tham gia các khóa học
              nhưng tin mình lần nữa đi, ở đây có cực kì nhiều khóa học hay và đặc sắc do cả giảng viên Việt Nam và cũng có thể là giảng viên nước
              ngoài giảng dạy. Đây là một trung tâm uy tín nếu bạn đang phân vân không biết mình sẽ theo học ở đâu.
            </p>
          </div>
        </div>
        ...
        <div className={cx('educations')}>
          <div className={cx('educationschool')}>
            ...
            <p>
              Sau những giờ học ở trường và những kiến thức mình tìm hiểu được thì hiện tại thi mình đã nắm được sơ sơ phần html,css và javascript.
              Ngoài ra mình cũng được học thêm một số ngôn ngữ lập trình khác như là C,C++,Python,Java nhưng mà chỉ ở mức độ cơ bản.
            </p>
          </div>
          ...
          <div className={cx('educationschool')}>
            ...
            <span>Từ 2022 -- Hiện Tại</span>
            <p>
              Với công việc làm parttime này cho mình rất nhiều trải nghiệm thú vị cùng một khoản thu nhập tương đối để có thể duy trì cuộc sống sinh
              hoạt và học tập.
            </p>
          </div>
          ...
          <div className={cx('educationschoolnobefore')}>
            ...
            <p>
              Với các đề tài nghiên cứu khoa học mình đã học hỏi được rất nhiều kiến thức mới từ các người bạn đồng hành cùng những kinh nghiệm để có
              thể thực hiện được một đề tài nghiên cứu khoa học nào đó.
            </p>
          </div>
        </div>
      ...
      <div id="thanhtuu" className={cx('container_category-content', 'flexing')} style={{ boxShadow: '0 6px 10px rgba(0,0,0, 0.2)' }}>
        ...
        <div className={cx('projected')}>
          <img src={images.project1} alt="" className={cx('imggwshow3')} />
          <p className={cx('text')}>My Profile</p>
        </div>

        <div className={cx('projected')}>
          <img src={images.reactapp} alt="" className={cx('imggwshow3')} />
          <p className={cx('text')}>My ReactApp</p>
        </div>

        <div className={cx('projected')}>
          <img src={images.tmdt} alt="" className={cx('imggwshow3')} />
          <p className={cx('text')}>My Ecommerce</p>
        </div>

        <div className={cx('projected')}>
          <img src={images.theband} alt="" className={cx('imggwshow3')} />
      ...
      <div id="muctieu" className={cx('container_category-content', 'flexing')} style={{ boxShadow: '0 6px 10px rgba(0,0,0, 0.2)' }}>
        ...
        <div className={cx('educations')}>
          <div className={cx('educationschool')}>
            ...
            <p>
              Mình đang chuẩn bị học tiếng anh để lấy chứng chỉ ra trường cùng với đó mình sẽ cố gắng qua hết các môn để được ra trường đúng so với dự
              kiến.
            </p>
          </div>
          ...
          <div className={cx('educationschool')}>
            ...
            <p>
              Hiện tại mình đang dồn toàn lực để cải thiện nhanh nhất các kiến thức cơ bản nhất như thành thạo html, css, js, reactjs,....Mục tiêu là
              học những kiến thức cần và đủ để có thể đi làm được.
            </p>
          </div>
          ...
          <div className={cx('educationschoolnobefore')}>
            ...
            <span>Từ Hiện Tại -- Tương Lai</span>
            <p>
              Ngoài việc học tiếng anh để có chứng chỉ ra trường thì mình cũng có đam mê với tiếng Nhật. Mình sẽ cố gắng học song song để khả năng
              ngoại ngữ của mình đa năng hơn.
            </p>
          </div>
        </div>
        ...
        <div className={cx('educations')}>
          <div className={cx('educationschool')}>
            ...
            <p>
              Mình mong muốn phấn đấu để được đi thực tập ở một số nơi để làm quen với môi trường làm việc của ngành cùng với đó tìm hiểu thêm các
              công nghệ mà thị trường đang cần.
            </p>
          </div>
          ...
          <div className={cx('educationschool')}>
            ...
            <span>Từ Hiện Tại -- Tương Lai</span>
            <p>
              Mục tiêu dài hạn của mình là có một công việc dev ổn định và có thu nhập từ trung bình đến cao để có thể cảm nhận cuộc sống một cách tốt
              nhất. Cùng với đó mình mong muốn bản thân càng hoàn thiện về mặt kiến thức,....để có thể trở thành phiên bản tốt nhất của bản thân.
            </p>
          </div>
